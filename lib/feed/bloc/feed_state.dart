...
class FeedState extends Equatable {
  const FeedState({required this.status, this.feed = const {}, this.hasMoreNews = const {}});
  ...
  FeedState copyWith({FeedStatus? status, Map<String, List<NewsBlock>>? feed, Map<String, bool>? hasMoreNews}) {
    return FeedState(
