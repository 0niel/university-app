...
enum ItemType { group, teacher, classroom }

class SearchResultItem extends StatelessWidget {
  const SearchResultItem({super.key, required this.name, required this.onPressed, required this.type});
  ...
  Widget _buildTeacherItem(BuildContext context) {
    return Row(
      children: [
        ...
        Text(name, style: AppTextStyle.titleS.copyWith(color: Theme.of(context).extension<AppColors>()!.active)),
      ],
    );
  }
