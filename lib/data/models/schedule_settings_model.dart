...
class ScheduleSettingsModel extends ScheduleSettings {
  const ScheduleSettingsModel({required showEmptyLessons, required showLessonsNumbers, required calendarFormat})
    : super(showEmptyLessons: showEmptyLessons, showLessonsNumbers: showLessonsNumbers, calendarFormat: calendarFormat);
