...
class ScheduleExporterState extends Equatable {
  ...
  const ScheduleExporterState({this.isLoading = false, this.isSuccess = false, this.errorMessage = ''});

  /// Copies the current state and updates the fields with new values.
  ScheduleExporterState copyWith({bool? isLoading, bool? isSuccess, String? errorMessage}) {
