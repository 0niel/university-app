    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        controller: ScrollController(
          initialScrollOffset:
              selectedIndex > 2 ? (selectedIndex - 2) * itemWidth : 0,
        ),
...
class _CalendarWeeksHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        color: isMonthView ? null : colors.background02,
    ...
    return Container(
      ...
      child: PlatformTextButton(
        ...
        child: Container(
          ...
          child: Center(
            child: HugeIcon(icon: icon, color: colors.active, size: 16),
          ),
        ),
      ),
    );
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            if (!isMonthView) ...[
              Text(
                "${DateFormat.MMM(locale).format(day)[0].toUpperCase()}${DateFormat.MMM(locale).format(day).substring(1)} ${day.year}",
                style: AppTextStyle.body.copyWith(
                  color: colors.active,
                  fontWeight: FontWeight.w500,
                ),
