...
class ArticleThemeOverride extends StatelessWidget {
  const ArticleThemeOverride({required this.isVideoArticle, required this.child, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final textHighColor = isVideoArticle ? colors.primary : colors.active;

    final textMediumColor = isVideoArticle ? colors.primary : colors.deactive;

    final theme = Theme.of(context);
    final textTheme = theme.textTheme;
    return Theme(
      data: theme.copyWith(
        extensions: [ArticleThemeColors(captionNormal: textHighColor, captionLight: textMediumColor)],
        textTheme: textTheme.copyWith(
          displayMedium: textTheme.displayMedium?.copyWith(color: textHighColor),
...
class ArticleThemeColors extends ThemeExtension<ArticleThemeColors> with EquatableMixin {
  const ArticleThemeColors({required this.captionNormal, required this.captionLight});
