  ...
  static Future<void> _executeLoadingCallback({
    ...
    try {
      ...
      final errorSnackBar = SnackBar(
        behavior: SnackBarBehavior.floating,
        backgroundColor: AppTheme.colorsOf(context).colorful07,
        content: Row(
          children: [
  ...
  static Container _buildStatusIcon(BuildContext context, bool isSuccess) {
    return Container(
      ...
      child: HugeIcon(
        ...
        color: isSuccess ? AppTheme.colorsOf(context).colorful05 : AppTheme.colorsOf(context).colorful07,
        size: 20,
      ),
    );
  }
    ...
    final content = Row(
      children: [
        Container(
          ...
          child: HugeIcon(
            icon: isSuccess ? HugeIcons.strokeRoundedCheckmarkCircle01 : HugeIcons.strokeRoundedAlertCircle,
            color: isSuccess ? AppTheme.colorsOf(context).active : AppTheme.colorsOf(context).colorful07,
            size: 20,
          ),
        ),
        const SizedBox(width: 16),
