                        ...
                        child: Card(
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(state.announces[index].name, style: AppTextStyle.title),
                                const SizedBox(height: 6),
                                Text(
                                  state.announces[index].date,
                                  style: AppTextStyle.body.copyWith(color: AppColors.dark.deactive),
                                ),
                                ...
                                Html(
                                  ...
                                  extensions: const [VideoHtmlExtension(), SvgHtmlExtension()],
                                ),
                              ],
                            ),
                          ),
