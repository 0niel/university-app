...
class ConfigureFirebaseTest(unittest.TestCase):
    ...
    def test_release_workflows_prepare_native_configuration_before_build(self):
        ...
        self.assertIn('if [[ "$PLATFORM:$RELEASE_VERSION" = android:5.2.1+1005801 || "$PLATFORM:$RELEASE_VERSION" = android:5.2.1+1006201 || "$PLATFORM:$RELEASE_VERSION" = android:5.2.1+1006601 ]]; then', patch)
