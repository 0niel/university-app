...
class OnBoardingTest {
  ...
  static testFirstPage() {
    testWidgets('OnBoarding | Test first page content',
      ...
      // // Create the Finders.
      // final mainText = find.text(GetOnBoardingPages.firstPage.textWidget.data!);
      // final contentText = find.text(GetOnBoardingPages.firstPage.contentText);
    ...
    testWidgets('OnBoarding | Test swipe', (WidgetTester tester) async {
