...
void main() {
  group('Contributor', () {
    ...
    test('copyWith() should create an updated immutable model', () {
      const contributor = Contributor(
        login: 'user1',
        avatarUrl: 'http://avatar.com',
        htmlUrl: 'http://html.com',
      ...
      expect(
        contributor.copyWith(contributions: 11),
        isNot(same(contributor)),
      );
      expect(contributor.copyWith(contributions: 11).contributions, 11);
    });
  });
}
