...
_PostSmallBlock _$PostSmallBlockFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      '_PostSmallBlock',
      json,
      ($checkedConvert) {
        final val = _PostSmallBlock(
...
Map<String, dynamic> _$PostSmallBlockToJson(_PostSmallBlock instance) =>
    <String, dynamic>{
      'id': instance.id,
