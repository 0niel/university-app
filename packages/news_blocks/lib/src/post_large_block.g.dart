...
_PostLargeBlock _$PostLargeBlockFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      '_PostLargeBlock',
      json,
      ($checkedConvert) {
        final val = _PostLargeBlock(
...
Map<String, dynamic> _$PostLargeBlockToJson(_PostLargeBlock instance) =>
    <String, dynamic>{
      'id': instance.id,
