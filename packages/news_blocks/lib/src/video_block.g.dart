...
_VideoBlock _$VideoBlockFromJson(Map<String, dynamic> json) =>
    $checkedCreate('_VideoBlock', json, ($checkedConvert) {
      final val = _VideoBlock(
...
Map<String, dynamic> _$VideoBlockToJson(_VideoBlock instance) =>
