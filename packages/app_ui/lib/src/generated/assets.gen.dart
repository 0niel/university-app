...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/add_group.svg
  ...
  /// File path: assets/icons/gerb.ico
  String get gerb => 'packages/app_ui/assets/icons/gerb.ico';

  /// Directory path: assets/icons/hugeicons
  ...
  /// File path: assets/icons/lessons.svg
  SvgGenImage get lessons => const SvgGenImage('assets/icons/lessons.svg');
  ...
  /// File path: assets/icons/setting-02.svg
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/Saly-1.png
  AssetGenImage get saly1 => const AssetGenImage('assets/images/Saly-1.png');

  /// File path: assets/images/Saly-18.png
  AssetGenImage get saly18 => const AssetGenImage('assets/images/Saly-18.png');

  /// File path: assets/images/Saly-2.png
  AssetGenImage get saly2 => const AssetGenImage('assets/images/Saly-2.png');

  /// File path: assets/images/Saly-25.png
  AssetGenImage get saly25 => const AssetGenImage('assets/images/Saly-25.png');

  /// File path: assets/images/Saly-3.png
  AssetGenImage get saly3 => const AssetGenImage('assets/images/Saly-3.png');

  /// File path: assets/images/Saly-39.png
  AssetGenImage get saly39 => const AssetGenImage('assets/images/Saly-39.png');

  /// File path: assets/images/Saly-4.png
  AssetGenImage get saly4 => const AssetGenImage('assets/images/Saly-4.png');

  /// File path: assets/images/Saly-5.png
  AssetGenImage get saly5 => const AssetGenImage('assets/images/Saly-5.png');
...
class $AssetsMapsGen {
  ...
  String get objects => 'packages/app_ui/assets/maps/objects.json';
