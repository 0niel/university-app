  ...
  group('InlineVideo', () {
    ...
    testWidgets('renders progressIndicator when loading', (tester) async {
      ...
      await tester.pumpApp(
        InlineVideo(
          videoUrl: 'videoUrl',
          progressIndicator: const ProgressIndicator(key: progressIndicatorKey),
    ...
    testWidgets('plays video when tapped '
      ...
      await tester.tap(find.byKey(const Key('inlineVideo_gestureDetector')));
      await tester.pump();
...
class FakeVideoPlayerController extends ValueNotifier<VideoPlayerValue>
  ...
  // Routes members added in newer video_player versions (audio tracks,
  // playerId, ...) that the tests never exercise.
  @override
