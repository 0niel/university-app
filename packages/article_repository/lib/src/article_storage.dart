...
class ArticleStorage {
  ...
  Future<int> fetchArticleViews() async {
    final articleViews = await _storage.read(key: ArticleStorageKeys.articleViews);
  ...
  Future<DateTime?> fetchArticleViewsResetDate() async {
    final resetDate = await _storage.read(key: ArticleStorageKeys.articleViewsResetAt);
  ...
  Future<int> fetchTotalArticleViews() async {
    final count = await _storage.read(key: ArticleStorageKeys.totalArticleViews);
