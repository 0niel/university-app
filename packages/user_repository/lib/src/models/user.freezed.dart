...
@override
String toString() {
  return 'User(id: $id, email: $email, name: $name, photo: $photo, isNewUser: $isNewUser, isGuest: $isGuest)';
}
...
class _User extends User {
  const _User({required this.id, this.email, this.name, this.photo, this.isNewUser = true, this.isGuest = false}): super._();
