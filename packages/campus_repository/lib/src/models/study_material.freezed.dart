...
@JsonKey(defaultValue: '') String get id;@JsonKey(defaultValue: '') String get title; String get subjectName; List<String> get subjectNames; String get materialType; int get downloads; int get likes; int get price; int get pages; String get authorName; String get fileName; String get mimeType; int get fileSize; bool get hasFile; bool get requiresRepublish; bool get isMine;@JsonKey(fromJson: dateTimeFromJson, toJson: dateTimeToJson) DateTime? get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,subjectName,const DeepCollectionEquality().hash(subjectNames),materialType,downloads,likes,price,pages,authorName,fileName,mimeType,fileSize,hasFile,requiresRepublish,isMine,createdAt);

@override
String toString() {
  return 'StudyMaterial(id: $id, title: $title, subjectName: $subjectName, subjectNames: $subjectNames, materialType: $materialType, downloads: $downloads, likes: $likes, price: $price, pages: $pages, authorName: $authorName, fileName: $fileName, mimeType: $mimeType, fileSize: $fileSize, hasFile: $hasFile, requiresRepublish: $requiresRepublish, isMine: $isMine, createdAt: $createdAt)';
}
...
@useResult
$Res call({
@JsonKey(defaultValue: '') String id,@JsonKey(defaultValue: '') String title, String subjectName, List<String> subjectNames, String materialType, int downloads, int likes, int price, int pages, String authorName, String fileName, String mimeType, int fileSize, bool hasFile, bool requiresRepublish, bool isMine,@JsonKey(fromJson: dateTimeFromJson, toJson: dateTimeToJson) DateTime? createdAt
});
...
/// Create a copy of StudyMaterial
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? subjectName = null,Object? subjectNames = null,Object? materialType = null,Object? downloads = null,Object? likes = null,Object? price = null,Object? pages = null,Object? authorName = null,Object? fileName = null,Object? mimeType = null,Object? fileSize = null,Object? hasFile = null,Object? requiresRepublish = null,Object? isMine = null,Object? createdAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(defaultValue: '')  String id, @JsonKey(defaultValue: '')  String title,  String subjectName,  List<String> subjectNames,  String materialType,  int downloads,  int likes,  int price,  int pages,  String authorName,  String fileName,  String mimeType,  int fileSize,  bool hasFile,  bool requiresRepublish,  bool isMine, @JsonKey(fromJson: dateTimeFromJson, toJson: dateTimeToJson)  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _StudyMaterial() when $default != null:
return $default(_that.id,_that.title,_that.subjectName,_that.subjectNames,_that.materialType,_that.downloads,_that.likes,_that.price,_that.pages,_that.authorName,_that.fileName,_that.mimeType,_that.fileSize,_that.hasFile,_that.requiresRepublish,_that.isMine,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(defaultValue: '')  String id, @JsonKey(defaultValue: '')  String title,  String subjectName,  List<String> subjectNames,  String materialType,  int downloads,  int likes,  int price,  int pages,  String authorName,  String fileName,  String mimeType,  int fileSize,  bool hasFile,  bool requiresRepublish,  bool isMine, @JsonKey(fromJson: dateTimeFromJson, toJson: dateTimeToJson)  DateTime? createdAt)  $default,) {final _that = this;
switch (_that) {
case _StudyMaterial():
return $default(_that.id,_that.title,_that.subjectName,_that.subjectNames,_that.materialType,_that.downloads,_that.likes,_that.price,_that.pages,_that.authorName,_that.fileName,_that.mimeType,_that.fileSize,_that.hasFile,_that.requiresRepublish,_that.isMine,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,subjectName,const DeepCollectionEquality().hash(_subjectNames),materialType,downloads,likes,price,pages,authorName,fileName,mimeType,fileSize,hasFile,requiresRepublish,isMine,createdAt);
...
/// Create a copy of StudyMaterial
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? subjectName = null,Object? subjectNames = null,Object? materialType = null,Object? downloads = null,Object? likes = null,Object? price = null,Object? pages = null,Object? authorName = null,Object? fileName = null,Object? mimeType = null,Object? fileSize = null,Object? hasFile = null,Object? requiresRepublish = null,Object? isMine = null,Object? createdAt = freezed,}) {
