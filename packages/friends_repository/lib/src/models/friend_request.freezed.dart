...
mixin _$FriendRequest {
 ...
 String get friendshipId; String get userId;@JsonKey(defaultValue: 'Студент') String get fullName; String? get handle; String? get group;@JsonKey(fromJson: optionalDateTimeFromJson, toJson: optionalDateTimeToJson) DateTime? get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,friendshipId,userId,fullName,handle,group,createdAt);

@override
String toString() {
  return 'FriendRequest(friendshipId: $friendshipId, userId: $userId, fullName: $fullName, handle: $handle, group: $group, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String friendshipId, String userId,@JsonKey(defaultValue: 'Студент') String fullName, String? handle, String? group,@JsonKey(fromJson: optionalDateTimeFromJson, toJson: optionalDateTimeToJson) DateTime? createdAt
});
...
/// Create a copy of FriendRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? friendshipId = null,Object? userId = null,Object? fullName = null,Object? handle = freezed,Object? group = freezed,Object? createdAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String friendshipId,  String userId, @JsonKey(defaultValue: 'Студент')  String fullName,  String? handle,  String? group, @JsonKey(fromJson: optionalDateTimeFromJson, toJson: optionalDateTimeToJson)  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FriendRequest() when $default != null:
return $default(_that.friendshipId,_that.userId,_that.fullName,_that.handle,_that.group,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String friendshipId,  String userId, @JsonKey(defaultValue: 'Студент')  String fullName,  String? handle,  String? group, @JsonKey(fromJson: optionalDateTimeFromJson, toJson: optionalDateTimeToJson)  DateTime? createdAt)  $default,) {final _that = this;
switch (_that) {
case _FriendRequest():
return $default(_that.friendshipId,_that.userId,_that.fullName,_that.handle,_that.group,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String friendshipId,  String userId, @JsonKey(defaultValue: 'Студент')  String fullName,  String? handle,  String? group, @JsonKey(fromJson: optionalDateTimeFromJson, toJson: optionalDateTimeToJson)  DateTime? createdAt)?  $default,) {final _that = this;
switch (_that) {
case _FriendRequest() when $default != null:
return $default(_that.friendshipId,_that.userId,_that.fullName,_that.handle,_that.group,_that.createdAt);case _:
  return null;
...
class _FriendRequest implements FriendRequest {
  const _FriendRequest({required this.friendshipId, required this.userId, @JsonKey(defaultValue: 'Студент') required this.fullName, this.handle, this.group, @JsonKey(fromJson: optionalDateTimeFromJson, toJson: optionalDateTimeToJson) this.createdAt});
...
@override@JsonKey(fromJson: optionalDateTimeFromJson, toJson: optionalDateTimeToJson) final  DateTime? createdAt;
...
/// Create a copy of FriendRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? friendshipId = null,Object? userId = null,Object? fullName = null,Object? handle = freezed,Object? group = freezed,Object? createdAt = freezed,}) {
