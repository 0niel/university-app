...
import 'package:schedule_api_client/src/models/ProfileResponse/edu_program_in_response.dart';
...
/// {@endtemplate}
@JsonSerializable()
class StudentInResponse extends Equatable {
  /// {@macro groups_response}
  const StudentInResponse({
    required this.id,
  ...
  /// Конвертирует `Map<String, dynamic>` в [StudentInResponse]
  factory StudentInResponse.fromJson(Map<String, dynamic> json) =>
  ...
  final EduProgramInResposne eduProgram;

  /// Конвертирует [StudentInResponse] в `Map<String, dynamic>`
