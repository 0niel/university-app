...
RtuMireaNewsItem _$RtuMireaNewsItemFromJson(Map<String, dynamic> json) =>
    RtuMireaNewsItem(
      ...
      tags: json['TAGS'] == null
          ? []
          : RtuMireaNewsItem._tagsFromJson(json['TAGS'] as String),
      coverImage: json['DETAIL_PICTURE'] as String,
      detailPageUrl: json['DETAIL_PAGE_URL'] as String,
    );

Map<String, dynamic> _$RtuMireaNewsItemToJson(RtuMireaNewsItem instance) =>
    <String, dynamic>{
      'NAME': instance.title,
