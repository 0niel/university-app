...
/// @Allow(GET)
Future<Response> onRequest(RequestContext context, String classroom) async {
  ...
  final schedule = await scheduleDataSource.getClassroomSchedule(classroom: classroom);
