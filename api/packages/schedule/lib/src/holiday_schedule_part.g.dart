...
HolidaySchedulePart _$HolidaySchedulePartFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      'HolidaySchedulePart',
      json,
      ($checkedConvert) {
        final val = HolidaySchedulePart(
          ...
          type: $checkedConvert(
              'type', (v) => v as String? ?? HolidaySchedulePart.identifier),
        );
        return val;
      },
    );
