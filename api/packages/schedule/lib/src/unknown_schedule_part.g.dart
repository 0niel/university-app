...
UnknownSchedulePart _$UnknownSchedulePartFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      'UnknownSchedulePart',
      json,
      ($checkedConvert) {
        final val = UnknownSchedulePart(
          ...
          type: $checkedConvert(
              'type', (v) => v as String? ?? UnknownSchedulePart.identifier),
        );
        return val;
      },
    );
