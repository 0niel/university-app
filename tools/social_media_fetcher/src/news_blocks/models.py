...
class ArticleIntroductionBlock(NewsBlock):
    ...
    publishedAt: datetime = Field(
        ..., alias="published_at", description="Publishedat - DateTime"
    )
    imageUrl: str | None = Field(
        None, alias="image_url", description="Imageurl - String"
    )
...
class PostGridGroupBlock(NewsBlock):
    ...
    categoryId: str = Field(..., alias="category_id", description="Categoryid - String")
    tiles: list[PostGridTileBlock] = Field(
        ..., alias="tiles", description="Tiles - List of PostGridTileBlock"
    )
...
class SectionHeaderBlock(NewsBlock):
    ...
    title: str = Field(..., alias="title", description="Title - String")
    action: BlockAction = Field(
        None, alias="action", description="Action - BlockAction"
    )
...
class SlideshowBlock(NewsBlock):
    ...
    title: str = Field(..., alias="title", description="Title - String")
    slides: list[SlideBlock] = Field(
        ..., alias="slides", description="Slides - List of SlideBlock"
    )
...
class SlideshowIntroductionBlock(NewsBlock):
    ...
    title: str = Field(..., alias="title", description="Title - String")
    coverImageUrl: str | None = Field(
        None, alias="cover_image_url", description="Coverimageurl - String"
    )
    action: BlockAction | NavigateToSlideshowAction = Field(
        None, alias="action", description="Action - BlockAction"
    )
...
class SlideBlock(NewsBlock):
    ...
    description: str = Field(
        ..., alias="description", description="Description - String"
    )
    photoCredit: str = Field(
        ..., alias="photo_credit", description="Photocredit - String"
    )
    imageUrl: str | None = Field(
        None, alias="image_url", description="Imageurl - String"
    )
...
class TextCaptionBlock(NewsBlock):
    ...
    color: TextCaptionColor = Field(
        ..., alias="color", description="Color - TextCaptionColor"
    )
...
class TrendingStoryBlock(NewsBlock):
    ...
    content: PostSmallBlock = Field(
        ..., alias="content", description="Content - PostSmallBlock"
    )
